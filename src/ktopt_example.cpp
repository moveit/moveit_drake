...
#include <pluginglib/class_loader.h>
...
{
    // ros related spinups
    const std::string NODE_NAME = "ktopt_example";
    ...
    // create a RobotState and to keep track of the current robot pose and
    // planning group
    moveit::core::RobotStatePtr robot_state(
        new moveit::core::RobotState(
    ...
    // set the planner
    std::string planner_plugin_name = "ktopt_interface/KTOptPlanner";
    ...
    // Set start and goal joint state
    planning_interface::MotionPlanRequest req;
    planning_interface::MotionPlanResponse res;
    req.group_name = PLANNING_GROUP;

    // Get Joint values of the start state and set them in request.start state
    std::vector<double> start_joint_values;
    robot_state->copyJointGroupPositions(joint_model_group, start_joint_values);
    req.start-state.joint_state.position = start_joint_values;
